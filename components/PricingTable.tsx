...
const features = [
  ...
  { name: "Road Back Indicator", free: true, pro: true },
  { name: "On-Screen Compass & Ruler", free: true, pro: true },
  { name: "Track Overlay (up to 7)", free: false, pro: true },
  { name: "Heatmap Visualization", free: false, pro: true },
  { name: "Perimeter Guard", free: false, pro: true },
  { name: "Permission Vault + PDF Letters", free: false, pro: true },
  { name: "USGS Historical Map Overlay", free: false, pro: true },
  { name: "Offline Maps (4 tile sources)", free: false, pro: true },
  { name: "Detecting Forecast", free: false, pro: true },
  { name: "Tide Table (14-day)", free: false, pro: true },
  { name: "Nearby Historic Sites", free: false, pro: true },
  { name: "Cloud Backup (Google Drive)", free: false, pro: true },
  { name: "Session Comparison", free: false, pro: true },
  { name: "Night Vision Mode", free: false, pro: true },
  { name: "Coin Caliper", free: false, pro: true },
  { name: "GPX / KML / CSV Export", free: false, pro: true },
  { name: "All 12 Themes", free: "3 themes", pro: "All 12" },
];
      ...
      <div ref={ref} className={`max-w-3xl mx-auto px-6 reveal ${visible ? "visible" : ""}`}>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-10">
          ...
          <div className="rounded-2xl border border-accent/30 bg-accent/5 p-6 relative">
            ...
            <div className="text-3xl font-bold mb-1">$2.99<span className="text-base font-normal text-muted">/mo</span></div>
            <div className="text-xs text-muted mb-4">or $19.99/year (save 44%). 7-day free trial.</div>
