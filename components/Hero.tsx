        ...
        <div className="grid md:grid-cols-[1.4fr_0.6fr] gap-3 items-center">
          <div className="text-center md:text-left">
            ...
            <div className="hero-enter flex flex-wrap gap-2 mb-6 justify-center md:justify-start" style={{ animationDelay: "0.15s" }}>
              <a href="#community" className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-400/30 text-amber-300 text-xs font-medium hover:bg-amber-500/15 hover:border-amber-400/50 transition-colors">
