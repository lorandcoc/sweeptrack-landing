  ...
  // No aggregateRating/review until real Google Play ratings exist. Fake ratings = Google spam manual action.
  {
    ...
    offers: [
      ...
      },
      {
        ...
        name: "Pro Annual",
        availability: "https://schema.org/InStock",
        description: "Everything unlimited. $19.99/year (save 52% vs monthly). Free trial when eligible.",
        priceValidUntil: "2027-12-31",
      },
      {
        "@type": "Offer",
    ...
    featureList: [
      ...
      "Night vision red-on-black mode for low-light detecting at dawn and dusk (Pro)",
      ...
      "9 color themes: 3 free (Steel, Copper, Tactical), 6 more with Pro, plus free High Contrast and Daylight modes",
      ...
      "Ad-free: no ads and no advertising trackers; crash and usage diagnostics are opt-in and anonymized",
    ],
    url: "https://sweeptrack.pro",
