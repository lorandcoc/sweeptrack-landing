      ...
      <div ref={ref} className={`max-w-4xl mx-auto px-6 reveal ${visible ? "visible" : ""}`}>
        <div className="relative border border-white/[0.06] rounded-3xl p-10 md:p-16 text-center bg-surface/50 overflow-hidden">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-xs text-muted mb-8">
            {(["featuretag.gps", "featuretag.livegroup", "featuretag.waypoints", "featuretag.forecast", "featuretag.offline", "featuretag.cloud", "featuretag.permission", "featuretag.track"] as const).map((k) => (
