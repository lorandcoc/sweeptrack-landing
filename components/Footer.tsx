...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/sweeptrackpro/",
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@SweepTrackPro",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/sweeptrackpro/",
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@sweep.track.pro",
