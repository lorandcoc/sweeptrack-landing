...
const posts = [
  ...
  // ── BEACH ──
  { slug: "beach-metal-detecting-tide-timing", title: "Beach Detecting: Tide Timing & Where to Search", excerpt: "Low tide is when the gold comes out. Learn how to time your sessions and where to swing.", tag: "Beach", category: "beach", readTime: "5 min", thumbnail: "/screenshots/forecast.png" },

  // ── APP TUTORIALS ──
  { slug: "detecting-forecast-guide", title: "Detecting Forecast: Plan Every Session by the Numbers", excerpt: "0-100 Detecting Score for any location, any day up to a week ahead. Soil moisture, wind, temp, humidity, and smart tips.", tag: "Tutorial", category: "tutorials", readTime: "4 min", thumbnail: "/screenshots/forecast.png" },
  ...
  { slug: "downloading-offline-maps", title: "Downloading Offline Maps for Areas Without Cell Service", excerpt: "4 tile sources. Pan, zoom, download. Detect confidently with zero cell coverage.", tag: "Tutorial", category: "tutorials", readTime: "3 min", thumbnail: "/screenshots/offline_maps.png" },
  ...
  { slug: "night-vision-mode", title: "Night Vision Mode for Dawn and Dusk Detecting", excerpt: "Red-on-black display preserves your eyes. Toggle it for early morning and late evening sessions.", tag: "Tutorial", category: "tutorials", readTime: "2 min", thumbnail: "/screenshots/night_vision.png" },
