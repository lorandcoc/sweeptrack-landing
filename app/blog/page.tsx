...
const posts = [
  ...
  { slug: "logging-finds-photo-video-audio", title: "Logging Finds with Photos and Audio Notes", excerpt: "4 find types (Treasure, Gold, Trash, Void), quick pin drop, depth 0-40 cm, value, weight, a photo and an audio recording per find.", tag: "Tutorial", category: "tutorials", readTime: "3 min", thumbnail: "/screenshots/stats.png" },
