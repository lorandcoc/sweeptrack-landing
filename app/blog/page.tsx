...
const posts = [
  ...
  { slug: "using-track-overlay", title: "Using Track Overlay to See Where You Already Walked", excerpt: "Load past sessions onto the live map as color-coded overlay paths. Five cycling colors make coverage gaps obvious.", tag: "Tutorial", category: "tutorials", readTime: "3 min", thumbnail: "/screenshots/home.jpg" },
  ...
  { slug: "logging-finds-photo-video-audio", title: "Logging Finds with Photos and Audio Notes", excerpt: "6 find types (Treasure, Gold, Coin, Relic, Jewelry, Trash), quick pin drop, depth 0-40 cm, value, weight, a photo and an audio recording per find.", tag: "Tutorial", category: "tutorials", readTime: "3 min", thumbnail: "/screenshots/stats.jpg" },
  { slug: "using-coin-caliper", title: "Using the Coin Caliper to Identify Dirty or Worn Coins", excerpt: "Place the coin on screen, adjust the slider, and the app matches it by diameter.", tag: "Tutorial", category: "tutorials", readTime: "3 min", thumbnail: "/screenshots/presets.jpg" },
  { slug: "finding-historic-sites-nearby", title: "Finding Historic Sites and Landmarks Near You", excerpt: "Historical POIs and Wikipedia articles around your location. Distance and directions included.", tag: "Tutorial", category: "tutorials", readTime: "3 min", thumbnail: "/screenshots/nearby.jpg" },
