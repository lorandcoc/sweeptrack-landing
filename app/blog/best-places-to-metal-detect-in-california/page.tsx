...
export const metadata: Metadata = {
  ...
  description:
    "California's Gold Rush history, long coastline, and desert ghost towns create unique detecting opportunities. Here's where to look and what the rules are.",
};
