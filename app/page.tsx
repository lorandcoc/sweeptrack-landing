...
const jsonLdGraph = [
  ...
  },
  {
    ...
    description:
      "Metal detecting GPS app with USGS historical topographic map overlay, offline maps (4 sources), track overlay, perimeter guard, permission vault, detecting forecast, NOAA tide tables, Google Drive backup, and preset templates for 57 detectors from 12 brands including Minelab, Garrett, XP, Nokta, and Fisher.",
    offers: [
      {
        "@type": "Offer",
        price: "0",
    ...
    featureList: [
      ...
      "10 detector preset slots with JSON import/export and templates for 57 detectors across 12 brands",
      "Find logging with 4 types (Treasure, Gold, Trash, Void), 0-40 cm depth, photo, and audio notes",
      "Quick pin drop for instant find marking",
      "Coverage heatmap and grid search overlay with coverage percentage",
      "Session comparison — up to 5 sessions in overlay or split view",
      "Session replay with 0.5×/1×/2×/4× playback speed",
      "Elevation profile per session",
      "Nearby historic sites from OpenStreetMap and Wikipedia",
      "Coin caliper with built-in database of 71 coins across 9 regions",
      ...
      "5-rank XP system, achievements, and 5 personal challenges",
