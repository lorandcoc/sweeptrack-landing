...
Hatálybalépés napja: 2026. május 12. · Utolsó frissítés: 2026. június 4.
...
Az Alkalmazás **adatvédelem-központú architektúrával** készült: minden keresési adatot helyben, az Ön eszközén tárolunk, nem üzemeltetünk olyan háttérszervereket, amelyek tárolnák az Ön keresési adatait, és nem gyűjtjük, továbbítjuk vagy értékesítjük az Ön személyes keresési adatait. Csekély mennyiségű adat kizárólag a 3.2. és 3.3. szakaszban leírt, az Ön által kezdeményezett funkciók céljából hagyja el az eszközét (valós idejű API-funkciók, opcionális biztonsági mentés, opcionális diagnosztika és opcionális visszajelzés). A Weboldal külön működik, és saját adatkezelési gyakorlattal rendelkezik, amelyet a 4. szakasz ismertet.
...
- **Az Alkalmazás** nem értékesíti, nem béreli ki és nem cseréli ki az adatait, és csak ott osztja meg, ahol Ön kezdeményezi: a 3.2. szakaszban szereplő valós idejű API-hívások, az opcionális Google Drive biztonsági mentés, az opt-in Firebase diagnosztika, valamint az Ön által beküldött visszajelzés (3.3. szakasz)
- **Az Alkalmazás** nem üzemeltet olyan szervereket, amelyek az Ön keresési adatait (helymeghatározás, találatok, kasszabejegyzések, munkamenetek) fogadják, dolgozzák fel vagy tárolják; az egyetlen, Ön által begépelt tartalom, amely egy általunk üzemeltetett szerverre eljut, az Ön által beküldeni választott visszajelzés (3.3. szakasz)
...
Nem értékesítjük, nem béreljük ki és nem cseréljük ki az Ön személyes adatait. Választhatja az Alkalmazás adatainak megosztását exportokon keresztül (GPX, KML, CSV, JSON), munkamenet-megosztási kártyákon vagy a Google Drive biztonsági mentésén — mindegyiket a felhasználó kezdeményezi. Ha alkalmazáson belüli visszajelzést küld be, azt a nevünkben a Supabase dolgozza fel (lásd a 3.3. szakaszt). A Weboldal várólista adatait csak a megnevezett adatfeldolgozóink (Supabase, Resend) dolgozzák fel a 4. szakaszban leírt célokra.
